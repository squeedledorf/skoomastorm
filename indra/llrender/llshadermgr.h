...
// [/RLVa:KB]
        ...
        // <SS:Nexii> SkoomaStorm and FS reserved uniforms. Appended at the end so Alchemy's indices stay put.
        SS_NOISE_LARGE_MAP,                  //  "ss_noise_large"
        SS_NOISE_LARGE_MAP_NEXT,             //  "ss_noise_large_next"
