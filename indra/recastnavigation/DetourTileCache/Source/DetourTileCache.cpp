...
{
	const int MAX_TILES = 512;	// <SS:Nexii> ALTERED FROM UPSTREAM: every layer a column can hold (SSNavMesh: 12 bands x 32 layers = 384); upstream touched only the first 32 of a column, silently.
