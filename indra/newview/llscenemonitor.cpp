...
void LLSceneMonitor::compare()
{
    ...
    gGL.getTextureSlot(0)->bind(mFrames[0], false, gGL.getSampler(ALSamplers::PointClamp));
    gGL.getTextureSlot(1)->bind(mFrames[1], false, gGL.getSampler(ALSamplers::PointClamp));
