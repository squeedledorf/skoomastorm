...
// [/RLVa:KB]
    ...
    virtual const LLMatrix4a& getRenderMatrix() const; // SKOOMA-PORT: LLMatrix4a, as Alchemy
    ...
    virtual const LLMatrix4a& getWorldMatrix(LLXformMatrix* xform) const    { return xform->getWorldMatrix(); } // SKOOMA-PORT: LLMatrix4a, as Alchemy
