...
public:
    ...
    // SkoomaStorm: time-smoothed lower-body strafe lean (radians) used while combat-aiming with
    // locked facing, so direction changes ease instead of jerking. See updateOrientation().
    F32 mCombatLeanRad = 0.f;
